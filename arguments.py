...
def train_args_parser():
    ...
    # parser.add_argument("--ngpu", help="number of gpu", type=int)        
    ...
    parser.add_argument("--train_result_filename", help="train_result_filename", type=str)
    parser.add_argument("--test_result_filename", help="test_result_filename", type=str)
